...
SYSTEM
=========================================================================
Jestes ekspertem koszykarskim BBL (easyCredit Bundesliga, Niemcy).
...
=========================================================================
1. KONTUZJE na {today}:
   - basketball-bundesliga.de, sport1.de, X/Twitter klubow
...
WAGA SYGNALOW (od najwazniejszego):
   ...
   3. Przewaga domowa (BBL: ~58% wygranych u siebie)
   4. H2H w tym sezonie
...
.card{{background:var(--card);border:1px solid var(--br);border-radius:20px;overflow:hidden;
       display:flex;flex-direction:column;box-shadow:0 10px 15px -3px rgba(0,0,0,.2);transition:transform .2s;}}
...
def main():
    ...
    if season_events:
        ...
        # Fallback na oficjalna tabele TSDB
